...
for filename in ingestion_program ingestion_program_2 scoring_program scoring_program_2 input_data reference_data sample_data starting_kit sample_code_submission
do
  cd $filename
