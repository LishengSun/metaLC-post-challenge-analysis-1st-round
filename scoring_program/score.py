...
if __name__ == "__main__":
    ...
    for dataset_name in list_datasets:
        ...
        try:
          ...
          vprint(verbose, "Warning: File" + output_file + " is not found")
    ...
    if len(list_final_score)!=0:
        average_final_score = sum(list_final_score) / len(list_datasets)
    if len(list_alc)!=0:
        average_alc = sum(list_alc) / len(list_datasets)
